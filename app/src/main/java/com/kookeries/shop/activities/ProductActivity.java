...
import com.kookeries.shop.adapters.ProductImagesAdapter;
...
public class ProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.sectionTitle)).setText("You May Also Like");
...
//                recreate();
        ...
        RecyclerView rvProducts = (RecyclerView) findViewById(R.id.sectionBody);
    ...
    private void populateData(){
        ...
        Product.selected.getCategory().takeProducts(8, true, Product.selected, new Category.DataReadyListener() {
            @Override
